      ...
      <section className="container mx-auto px-4 py-16 text-center">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <video className="w-full rounded-lg shadow-lg" controls autoPlay muted loop playsInline>
            <source src="/videos/explainer.mp4?v=2" type="video/mp4" />
...
Answers every call and books instantly so no pet owner slips through the cracks.</p>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mt-12">
          <Button size="lg" onClick={scrollToBooking} className="bg-primary hover:bg-primary/90">Book Your Demo</Button>
        </div>
      </section>
      ...
      <footer className="border-t border-border py-8">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>© 2026 GhostFrame Marketing. All rights reserved.</p>
        </div>
      </footer>
